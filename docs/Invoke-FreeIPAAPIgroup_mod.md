...
```
Invoke-FreeIPAAPIgroup_mod [[-desc] <String>] [[-gid] <Int32>] [[-setattr] <String[]>] [[-addattr] <String[]>]
 [[-delattr] <String[]>] [-rights] [-posix] [-external] [-all] [-raw] [[-version] <String>] [-no_members]
 [[-rename] <String>] [-group_name] <String> [-FullResultsOutput] [<CommonParameters>]
```
