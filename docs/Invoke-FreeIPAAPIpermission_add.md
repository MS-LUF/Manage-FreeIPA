...
```
Invoke-FreeIPAAPIpermission_add [[-right] <String[]>] [[-attrs] <String[]>] [[-bindtype] <String>]
 [[-subtree] <String>] [[-filter] <String[]>] [[-rawfilter] <String[]>] [[-target] <String>]
 [[-targetto] <String>] [[-targetfrom] <String>] [[-memberof] <String[]>] [[-targetgroup] <String>]
 [[-type] <String>] [[-setattr] <String[]>] [[-addattr] <String[]>] [-all] [-raw] [[-version] <String>]
 [-no_members] [-name] <String> [-FullResultsOutput] [<CommonParameters>]
```
