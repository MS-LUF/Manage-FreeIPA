...
```
Invoke-FreeIPAAPItrustdomain_add [[-flat_name] <String>] [[-sid] <String>] [[-setattr] <String[]>]
 [[-addattr] <String[]>] [[-type] <String>] [-all] [-raw] [[-version] <String>] [-trust] <String>
 [-domain] <String> [-FullResultsOutput] [<CommonParameters>]
```
