...
```
Invoke-FreeIPAAPIuser_remove_certmapdata [[-issuer] <String>] [[-subject] <String>] [[-certificate] <String[]>]
 [-all] [-raw] [[-version] <String>] [-no_members] [-login] <String> [[-certmapdata] <String[]>]
