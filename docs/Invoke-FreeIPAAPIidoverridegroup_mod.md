...
```
Invoke-FreeIPAAPIidoverridegroup_mod [[-desc] <String>] [[-group_name] <String>] [[-gid] <Int32>]
 [[-setattr] <String[]>] [[-addattr] <String[]>] [[-delattr] <String[]>] [-rights] [-fallback_to_ldap] [-all]
 [-raw] [[-version] <String>] [[-rename] <String>] [-idview] <String> [-anchor] <String> [-FullResultsOutput]
 [<CommonParameters>]
```
