...
```
Invoke-FreeIPAAPIhbactest [-user] <String> [-host] <String> [-service] <String> [[-rules] <String[]>]
 [-nodetail] [-enabled] [-disabled] [[-sizelimit] <Int32>] [[-version] <String>] [-FullResultsOutput]
 [<CommonParameters>]
```
...
### -rules
Rules to test.
If not specified, -enabled is assumed
