...
```
Invoke-FreeIPAAPIcertmaprule_find [[-rulename] <String>] [[-desc] <String>] [[-maprule] <String>]
 [[-matchrule] <String>] [[-domain] <String[]>] [[-priority] <Int32>] [-ipaenabledflag] [[-timelimit] <Int32>]
