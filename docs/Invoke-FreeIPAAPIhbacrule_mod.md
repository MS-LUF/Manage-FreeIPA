...
```
Invoke-FreeIPAAPIhbacrule_mod [[-type] <String>] [[-usercat] <String>] [[-hostcat] <String>]
 [[-servicecat] <String>] [[-desc] <String>] [-ipaenabledflag] [[-externalhost] <String[]>]
 [[-setattr] <String[]>] [[-addattr] <String[]>] [[-delattr] <String[]>] [-rights] [-all] [-raw]
 [[-version] <String>] [-no_members] [[-rename] <String>] [-name] <String> [-FullResultsOutput]
 [<CommonParameters>]
```
