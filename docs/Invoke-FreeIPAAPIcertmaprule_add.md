...
```
Invoke-FreeIPAAPIcertmaprule_add [[-desc] <String>] [[-maprule] <String>] [[-matchrule] <String>]
 [[-domain] <String[]>] [[-priority] <Int32>] [-ipaenabledflag] [[-setattr] <String[]>] [[-addattr] <String[]>]
 [-all] [-raw] [[-version] <String>] [-rulename] <String> [-FullResultsOutput] [<CommonParameters>]
```
