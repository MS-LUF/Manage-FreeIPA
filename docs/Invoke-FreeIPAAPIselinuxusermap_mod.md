...
```
Invoke-FreeIPAAPIselinuxusermap_mod [[-selinuxuser] <String>] [[-hbacrule] <String>] [[-usercat] <String>]
 [[-hostcat] <String>] [[-desc] <String>] [-ipaenabledflag] [[-setattr] <String[]>] [[-addattr] <String[]>]
 [[-delattr] <String[]>] [-rights] [-all] [-raw] [[-version] <String>] [-no_members] [-name] <String>
