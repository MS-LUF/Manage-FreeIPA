...
```
Invoke-FreeIPAAPIservice_add_smb [[-setattr] <String[]>] [[-addattr] <String[]>] [[-certificate] <String[]>]
 [-ok_as_delegate] [-ok_to_auth_as_delegate] [-all] [-raw] [[-version] <String>] [-no_members]
 [-hostname] <String> [[-netbiosname] <String>] [-FullResultsOutput] [<CommonParameters>]
```
