...
```
Invoke-FreeIPAAPIsudorule_add [[-desc] <String>] [-ipaenabledflag] [[-usercat] <String>] [[-hostcat] <String>]
 ...
 [[-runasexternalgroup] <String>] [[-setattr] <String[]>] [[-addattr] <String[]>] [-all] [-raw]
 [[-version] <String>] [-no_members] [-sudorule_name] <String> [-FullResultsOutput] [<CommonParameters>]
```
