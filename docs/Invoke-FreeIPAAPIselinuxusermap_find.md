...
```
Invoke-FreeIPAAPIselinuxusermap_find [[-name] <String>] [[-selinuxuser] <String>] [[-hbacrule] <String>]
 [[-usercat] <String>] [[-hostcat] <String>] [[-desc] <String>] [-ipaenabledflag] [[-timelimit] <Int32>]
