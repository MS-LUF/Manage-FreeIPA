...
```
Invoke-FreeIPAAPIpwpolicy_find [[-group] <String>] [[-maxlife] <Int32>] [[-minlife] <Int32>]
 [[-history] <Int32>] [[-minclasses] <Int32>] [[-minlength] <Int32>] [[-priority] <Int32>] [[-maxfail] <Int32>]
 [[-failinterval] <Int32>] [[-lockouttime] <Int32>] [[-timelimit] <Int32>] [[-sizelimit] <Int32>] [-all] [-raw]
