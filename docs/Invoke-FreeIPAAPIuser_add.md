...
```
Invoke-FreeIPAAPIuser_add [-first] <String> [-last] <String> [-cn] <String> [[-displayname] <String>]
 ...
 [[-certificate] <String[]>] [-disabled] [[-setattr] <String[]>] [[-addattr] <String[]>] [-noprivate] [-all]
 [-raw] [[-version] <String>] [-no_members] [-login] <String> [-FullResultsOutput] [<CommonParameters>]
```
