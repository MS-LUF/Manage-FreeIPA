...
```
Invoke-FreeIPAAPIdnsforwardzone_find [[-name] <String>] [[-name_from_ip] <String>] [-zone_active]
 [[-forwarder] <String[]>] [[-forward_policy] <String>] [[-timelimit] <Int32>] [[-sizelimit] <Int32>] [-all]
 [-raw] [[-version] <String>] [-pkey_only] [[-criteria] <String>] [-FullResultsOutput] [<CommonParameters>]
```
