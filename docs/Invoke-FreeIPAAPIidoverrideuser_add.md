...
```
Invoke-FreeIPAAPIidoverrideuser_add [[-desc] <String>] [[-login] <String>] [[-uid] <Int32>] [[-gecos] <String>]
 ...
 [-fallback_to_ldap] [-all] [-raw] [[-version] <String>] [-idview] <String> [-anchor] <String>
