...
```
Invoke-FreeIPAAPIUser_Mod [-UID] <String> [[-First] <String>] [[-Last] <String>] [[-initials] <String>]
 [[-orgunit] <String>] [[-city] <String>] [[-shell] <String>] [[-email] <String[]>] [[-phone] <String[]>]
 [[-AddAttr] <String[]>] [[-SetAttr] <String[]>] [-All] [-random] [-FullResultsOutput] [<CommonParameters>]
```
