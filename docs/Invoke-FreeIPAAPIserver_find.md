...
```
Invoke-FreeIPAAPIserver_find [[-name] <String>] [[-minlevel] <Int32>] [[-maxlevel] <Int32>]
 [[-timelimit] <Int32>] [[-sizelimit] <Int32>] [-all] [-raw] [[-version] <String>] [-no_members] [-pkey_only]
 [[-topologysuffixes] <String[]>] [[-no_topologysuffixes] <String[]>] [[-in_locations] <String[]>]
 [[-not_in_locations] <String[]>] [[-servroles] <String[]>] [[-criteria] <String>] [-FullResultsOutput]
 [<CommonParameters>]
```
