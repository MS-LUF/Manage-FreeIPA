...
```
Invoke-FreeIPAAPIvault_mod_internal [[-desc] <String>] [[-type] <String>] [[-salt] <String>]
 [[-public_key] <String>] [[-setattr] <String[]>] [[-addattr] <String[]>] [[-delattr] <String[]>] [-rights]
 [[-service] <String>] [-shared] [[-user] <String>] [-all] [-raw] [[-version] <String>] [-no_members]
