...
```
Invoke-FreeIPAAPIcaacl_add [[-desc] <String>] [-ipaenabledflag] [[-cacat] <String>] [[-profilecat] <String>]
 [[-usercat] <String>] [[-hostcat] <String>] [[-servicecat] <String>] [[-setattr] <String[]>]
 [[-addattr] <String[]>] [-all] [-raw] [[-version] <String>] [-no_members] [-name] <String>
