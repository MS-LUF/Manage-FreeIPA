...
```
Invoke-FreeIPAAPItopologysuffix_add [-suffix_dn] <String> [[-setattr] <String[]>] [[-addattr] <String[]>]
 [-all] [-raw] [[-version] <String>] [-name] <String> [-FullResultsOutput] [<CommonParameters>]
```
