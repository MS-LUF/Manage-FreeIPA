...
```
Invoke-FreeIPAAPIca_add [[-desc] <String>] [-subject] <String> [[-setattr] <String[]>] [[-addattr] <String[]>]
 [-chain] [-all] [-raw] [[-version] <String>] [-name] <String> [-FullResultsOutput] [<CommonParameters>]
```
