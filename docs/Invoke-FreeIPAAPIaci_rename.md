...
```
Invoke-FreeIPAAPIaci_rename [[-permission] <String>] [[-group] <String>] [[-permissions] <String[]>]
 [[-attrs] <String[]>] [[-type] <String>] [[-memberof] <String>] [[-filter] <String>] [[-subtree] <String>]
 [[-targetgroup] <String>] [-self] [-prefix] <String> [-newname] <String> [-all] [-raw] [[-version] <String>]
