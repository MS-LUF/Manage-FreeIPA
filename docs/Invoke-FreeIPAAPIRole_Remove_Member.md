...
```
Invoke-FreeIPAAPIRole_Remove_Member [-cn] <String> [[-Users] <String[]>] [[-Groups] <String[]>]
 [[-Hosts] <String[]>] [[-Hostgroups] <String[]>] [[-Services] <String[]>] [-NoMembers] [-All]
