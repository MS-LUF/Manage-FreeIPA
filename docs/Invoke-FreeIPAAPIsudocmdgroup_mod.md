...
```
Invoke-FreeIPAAPIsudocmdgroup_mod [[-desc] <String>] [[-setattr] <String[]>] [[-addattr] <String[]>]
 [[-delattr] <String[]>] [-rights] [-all] [-raw] [[-version] <String>] [-no_members]
 [-sudocmdgroup_name] <String> [-FullResultsOutput] [<CommonParameters>]
```
