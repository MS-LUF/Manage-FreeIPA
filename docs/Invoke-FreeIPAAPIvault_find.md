...
```
Invoke-FreeIPAAPIvault_find [[-name] <String>] [[-desc] <String>] [[-type] <String>] [[-timelimit] <Int32>]
 [[-sizelimit] <Int32>] [[-service] <String>] [-shared] [[-user] <String>] [-services] [-users] [-all] [-raw]
