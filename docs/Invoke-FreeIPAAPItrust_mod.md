...
```
Invoke-FreeIPAAPItrust_mod [[-sid_blacklist_incoming] <String[]>] [[-sid_blacklist_outgoing] <String[]>]
 [[-upn_suffixes] <String[]>] [[-setattr] <String[]>] [[-addattr] <String[]>] [[-delattr] <String[]>] [-rights]
 [-all] [-raw] [[-version] <String>] [-realm] <String> [-FullResultsOutput] [<CommonParameters>]
```
...
available.
More specific options will be added in coming releases.
