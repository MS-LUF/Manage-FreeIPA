...
```
Invoke-FreeIPAAPIautomountmap_add_indirect [[-desc] <String>] [[-setattr] <String[]>] [[-addattr] <String[]>]
 [-mount] <String> [[-parentmap] <String>] [-all] [-raw] [[-version] <String>] [-automountlocation] <String>
