...
```
Invoke-FreeIPAAPIservice_mod [[-principal] <String[]>] [[-certificate] <String[]>] [[-pac_type] <String[]>]
 ...
 [[-version] <String>] [-no_members] [-canonical_principal] <String> [-FullResultsOutput] [<CommonParameters>]
```
