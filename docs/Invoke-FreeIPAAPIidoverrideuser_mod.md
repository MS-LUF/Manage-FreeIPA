...
```
Invoke-FreeIPAAPIidoverrideuser_mod [[-desc] <String>] [[-login] <String>] [[-uid] <Int32>] [[-gecos] <String>]
 [[-gidnumber] <Int32>] [[-homedir] <String>] [[-shell] <String>] [[-ipaoriginaluid] <String>]
 [[-sshpubkey] <String[]>] [[-certificate] <String[]>] [[-setattr] <String[]>] [[-addattr] <String[]>]
 [[-delattr] <String[]>] [-rights] [-fallback_to_ldap] [-all] [-raw] [[-version] <String>] [[-rename] <String>]
