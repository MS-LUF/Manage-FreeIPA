...
```
Invoke-FreeIPAAPIdnsconfig_mod [[-forwarder] <String[]>] [[-forward_policy] <String>] [-allow_sync_ptr]
 [[-ipadnsversion] <Int32>] [[-setattr] <String[]>] [[-addattr] <String[]>] [[-delattr] <String[]>] [-rights]
