...
```
Invoke-FreeIPAAPItrustdomain_mod [[-flat_name] <String>] [[-sid] <String>] [[-setattr] <String[]>]
 [[-addattr] <String[]>] [[-delattr] <String[]>] [-rights] [[-type] <String>] [-all] [-raw]
 [[-version] <String>] [-trust] <String> [-domain] <String> [-FullResultsOutput] [<CommonParameters>]
```
