...
```
Invoke-FreeIPAAPIservicedelegationtarget_add [[-setattr] <String[]>] [[-addattr] <String[]>] [-all] [-raw]
 [[-version] <String>] [-delegation_name] <String> [-FullResultsOutput] [<CommonParameters>]
```
